...
function AddMoney({ open, handleClose }) {
  ...
  const setPersonalLimit = async () => {
    ...
    const res = await axios.put("/banking/set_limit", data, config);
    console.log(res)
    if (res.status === 200)
      setisAdded(true)
  }
          ...
          <div className={classes.paper}>
            ...
            <div className="addMoney">
              ...
              <div className="addMoney__addButton">
                <Button color="primary" className={classes.btn} onClick={setPersonalLimit}>
                  {!isAdded ? "Add to Budget" : "Added"}
                </Button>
              </div>
